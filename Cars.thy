...
proof -
  have "infinite {n. is_nat(n)}" 
    by (metis Nat_Transfer.transfer_int_nat_set_function_closures(5) Nat_Transfer.transfer_int_nat_set_function_closures(6) infinite_UNIV_char_0 infinite_super mem_Collect_eq subsetI transfer_nat_int_set_relations(1))
  then show ?thesis 
